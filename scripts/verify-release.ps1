...
$requiredLayout = @(
    ...
    'resources\app\backend\extension_registry.py',
    'resources\app\backend\routers\extensions.py',
    'resources\app\extension.schema.json',
    'resources\app\extensions\diagram\manifest.json',
    'resources\app\extensions\web\manifest.json',
    'resources\app\dist\index.html',
    'resources\app\dist\splash.html',
    'resources\app\dist\assets\arhub-icons.js',
    'resources\app\dist\assets\arhub-codex-desktop.css',
    'resources\app\dist\assets\arhub-codex-desktop.js',
    'resources\app\dist\assets\apple-ui-20260727.css',
